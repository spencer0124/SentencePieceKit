...
- **Entitlements File**: `Config/SentencePieceDemo.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/SentencePieceDemo.entitlements`:
...
// In your app
@main
struct SentencePieceDemoApp: App {
    var body: some Scene {
        WindowGroup {
            ContentView()
